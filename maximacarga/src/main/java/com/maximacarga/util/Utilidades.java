...
public class Utilidades {
    ...
    public static boolean verificarEncriptacion(String contrasenia,String contraseniaEncriptada) {
        ...
        //Si la contraseña que introduce el usuario es igual que la contraseña que hay en la base de datos devolvera true,//si no lo es, devolvera false
